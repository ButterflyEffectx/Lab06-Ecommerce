    ...
    <div className="p-4 border">
      ...
      {cartItems.length === 0 ? (
        ...
        <div>
          ...
          <div className="font-bold mt-4">Delivery: 100 / Total: ${total + 100 - discount}</div>
          ...
          {discount > 0 && <p className="text-green-500">Coupon applied! You saved ${discount.toFixed(2)}.</p>}
        </div>
      )}
    </div>
  );
